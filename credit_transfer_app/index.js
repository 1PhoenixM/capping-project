...
app.get('/', function (req, res) {
  pageBody = fs.readFileSync(path.join(__dirname, './html') + '/credits.html', 'utf-8');	
  res.send(pageBody);
});
...
app.get(rootAppDirectory + '/start', function (req, res) {
  pageBody = fs.readFileSync(path.join(__dirname, './html') + '/start.html', 'utf-8');	
  res.send(pageBody);
});
...
app.get(rootAppDirectory + '/createAccount', function (req, res) {
  pageBody = fs.readFileSync(path.join(__dirname, './html') + '/createAccount.html', 'utf-8');	
  res.send(pageBody);
});
...
app.get(rootAppDirectory + '/createAccountSuccess', function (req, res) {
  pageBody = fs.readFileSync(path.join(__dirname, './html') + '/createAccountSuccess.html', 'utf-8');	
  res.send(pageBody);
});
...
app.get(rootAppDirectory + '/login', function (req, res) {
  pageBody = fs.readFileSync(path.join(__dirname, './html') + '/login.html', 'utf-8');	
  res.send(pageBody);
});
...
app.get(rootAppDirectory + '/forgotPassword', function (req, res) {
  pageBody = fs.readFileSync(path.join(__dirname, './html') + '/forgotPassword.html', 'utf-8');	
  res.send(pageBody);
});
...
app.get(rootAppDirectory + '/forgotPasswordEmailSent', function (req, res) {
  pageBody = fs.readFileSync(path.join(__dirname, './html') + '/forgotPasswordEmailSent.html', 'utf-8');	
  res.send(pageBody);
});
...
app.get(rootAppDirectory + '/main', function (req, res) {
  pageBody = fs.readFileSync(path.join(__dirname, './html') + '/main.html', 'utf-8');	
  res.send(pageBody);
});
...
app.get(rootAppDirectory + '/changePassword', function (req, res) {
  pageBody = fs.readFileSync(path.join(__dirname, './html') + '/changePassword.html', 'utf-8');	
  res.send(pageBody);
});
...
app.get(rootAppDirectory + '/changePasswordSuccess', function (req, res) {
  pageBody = fs.readFileSync(path.join(__dirname, './html') + '/changePasswordSuccess.html', 'utf-8');	
  res.send(pageBody);
});
...
app.get(rootAppDirectory + '/courseSelection', function (req, res) {
  pageBody = fs.readFileSync(path.join(__dirname, './html') + '/courseSelection.html', 'utf-8');	
  res.send(pageBody);
});
...
app.get(rootAppDirectory + '/courseEvaluation', function (req, res) {
  pageBody = fs.readFileSync(path.join(__dirname, './html') + '/courseEvaluation.html', 'utf-8');	
  res.send(pageBody);
});
...
app.get(rootAppDirectory + '/requestCourse', function (req, res) {
  pageBody = fs.readFileSync(path.join(__dirname, './html') + '/requestCourse.html', 'utf-8');	
  res.send(pageBody);
});
...
app.get(rootAppDirectory + '/requestCourseConfirmation', function (req, res) {
  pageBody = fs.readFileSync(path.join(__dirname, './html') + '/requestCourseConfirmation.html', 'utf-8');	
  res.send(pageBody);
});
